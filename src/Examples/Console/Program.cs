...
using TacAnalyses.Serialization;
...
namespace Console
{
	class Program
	{
		...
		private static void RunSomeTests()
		{
			...
			var method = new MethodReference("Example1", PlatformType.Void)
			{
				ContainingType = type,
			};
			...
			method = new MethodReference("Example1", PlatformType.Void)
			{
				ContainingType = type,
			};
		...
		private static void RunGenericsTests()
		{
			...
			var methodExample = new MethodReference("Example", PlatformType.Void)
			{
		...
		private static void RunInterPointsToTests()
		{
			...
			var methodReference = new MethodReference("Example6", PlatformType.Void)
